...
const drinksMenu = [{
  ...
  name: "Iced Lattes",
  description: "All lattes made with dairy",
  price: "$5"
}];
const milkshakes = [{
  name: "Chocolate"
...
const combos = [{
  name: "East Combo",
  description: "Fried Rice + Boba",
  price: "$13"
}, {
  name: "Cesar Special",
  description: "Empanada + Tequeño + Boba",
  price: "$8"
}];
...
const MenuBoard = () => {
  ...
  return <div className="h-screen w-screen bg-gradient-to-br from-cream via-cream to-secondary overflow-hidden">
      ...
      loop: true,
      align: "start"
    }} setApi={setApi} className="h-full w-full">
            ...
            <div className="h-full w-full p-8 flex flex-col">
              ...
              <div className="flex-1 grid grid-cols-4 gap-6">
                ...
                <div className="bg-gradient-to-b from-navy via-navy to-primary rounded-lg p-5 text-white shadow-lg shadow-navy/30 flex flex-col">
                  <h3 className="font-display text-2xl font-semibold text-center mb-1 text-primary-foreground">
                    Today's Specials
                  </h3>
                  ...
                  {isLoading ? <div className="flex-1 flex items-center justify-center">
                    ...
                    </div> : isClosed ? <div className="flex-1 flex flex-col items-center justify-center space-y-3">
          ...
          <CarouselItem className="h-screen pl-0">
            <div className="h-full w-full bg-gradient-to-br from-navy via-navy to-primary p-10 flex flex-col items-center justify-center">
              ...
              <div className="flex-1 w-full max-w-5xl flex items-center justify-center">
                {isLoading ? <div className="w-10 h-10 border-3 border-gold/30 border-t-gold rounded-full animate-spin" /> : isClosed ? <div className="text-center space-y-6">
                  ...
                  </div> : dailyItems.length === 0 ? <p className="text-white/50 text-xl">No specials today — check our regular menu!</p> : <div className="grid grid-cols-2 gap-10 w-full">
                    {/* Available Items */}
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        {inStockItems.length === 0 && <p className="text-white/40 italic">All items sold out</p>}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        {outOfStockItems.length === 0 && <p className="text-white/40 italic">Nothing sold out yet!</p>}
                      </div>
                    </div>
                  </div>}
              </div>
